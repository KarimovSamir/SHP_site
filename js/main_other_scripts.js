...
//     // Показываем активный контент при загрузке страницы
//     const activeAboutTab = document.querySelector('._main_tabs_about_us-tab.active');
//     if (activeAboutTab) {
//         const aboutContentId = activeAboutTab.getAttribute('data-tab') + '-content';
...
//     const activeServiceTab = document.querySelector('._main_tabs_services-tab.active');
//     if (activeServiceTab) {
//         const serviceContentId = activeServiceTab.getAttribute('data-tab') + '-content';
//         const serviceContent = document.getElementById(serviceContentId);
//         if (serviceContent) {
